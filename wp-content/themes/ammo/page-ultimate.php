...
<body <?php body_class($body_classes); ?>>
    ...
    <div class="layout-wrapper">
        ...
        if(current_user_can('publish_pages')) {
            echo "<div class='alert alert-warning' role='alert' style='margin-bottom:0;'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
            You are using an Ultimate page template now and that is for your completely individual designed pages and the page design <strong>will not</strong> inherit & controlled by general Site Customize section. 
            You should use this template if this page needs to be styled very individual, otherwise you should turn back page template as Default.
            You see this message because you've logged in and capacity to edit and your ordinary site visitors won't. I just wanna inform you because many customers confusing & thinking about their customize section doesn't work.</div>";
        }
