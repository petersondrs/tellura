...
class ThemetonTheme_Customize {
    ...
    public static function customizer_custom_admin_head(){
          echo '<link rel="stylesheet/less" type="text/css" href="'.file_require(get_template_directory_uri().'/assets/less/style.less', true).'" />
               <script>
               less = {
               env: "development",
               async: false,
               ...
               <script src="'.get_template_directory_uri().'/assets/plugins/less.min.js"></script>';
    }
