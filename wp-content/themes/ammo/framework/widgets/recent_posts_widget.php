...
class tt_RecentPostsWidget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('exclude_posts'); ?>">Exclude category ID (optional) :</label>
            <input type="text" id="<?php echo $this->get_field_id('exclude_posts'); ?>" name="<?php echo $this->get_field_name('exclude_posts'); ?>" value="<?php echo $exclude_posts; ?>" size="3" />
